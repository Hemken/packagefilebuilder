...
{vieweralsosee "test" "help test"}{...}
{vieweralsosee "" "--"}{...}
{viewerjumpto "Syntax" "testhelp##syntax"}{...}
{viewerjumpto "Description" "testhelp##description"}{...}
{viewerjumpto "Options" "testhelp##options"}{...}
{viewerjumpto "Remarks" "testhelp##remarks"}{...}
{viewerjumpto "Examples" "testhelp##examples"}{...}
{title:Title}

{phang}
{bf:testhelp} {hline 2} Calculate whatever statistic
